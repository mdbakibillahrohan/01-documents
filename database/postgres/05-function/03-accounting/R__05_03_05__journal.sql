...
RETURNS void AS $post_journal$
    ...
    BEGIN
        ...
        FOR v_journal in select * from json_array_elements((p_data->>'journal_list')::json) Loop 
            ...
            values (uuid(), v_counter, nullif(v_journal->>'description', ''), v_debited_amount, v_credited_amount, v_journal->>'ledger_oid', v_ledger_balance, v_journal->>'subledger_oid', v_subledger_balance,
...
--PGPASSWORD='password' psql -h localhost -U postgres -d gds -f ./R__05_03_04__journal.sql